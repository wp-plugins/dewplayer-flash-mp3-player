...
Usage : Copy & Past this code into your post or page: [dewplayer:Path to your mp3 files on local or remote sites]. Multiple files are separated by a pipe (|).

Examples: [dewplayer:http://www.mymusic.com/mysong.mp3] or [dewplayer:song1.mp3|song2.mp3|song3.mp3].

Configurable parameters : Version (Classic/Mini/Multi), Background color, transparency, Volume, Auto start, Auto replay (Loop), Random play...

Plugin Version : 1.0 for Dewplayer 1.9
